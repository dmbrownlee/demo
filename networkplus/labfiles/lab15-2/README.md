...
## Section 1: Setting up the base System in virtualbox
									...
									Note 
	This configuration is just to network the local machines vms to each other, to access machines, repos and vms outside the local virtual network, additonal configuration will need to be done. That will be shown in lab 15-3
